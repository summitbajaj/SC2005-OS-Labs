...
{ 
  ...
  // using static variable that was created
  int i = fifoPointer;
...
printf("Page Fault here, Table 1\n");
...
int lruAlgorithm(void)
{
  ...
  //initialising earlistTime to max possible integer value, so that all pages are iterated 
